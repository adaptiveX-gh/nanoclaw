...
// ─── State Sync (REMOVED) ────────────────────────────────────────────
// sync_state_to_supabase tool removed — console-sync (host-side) pushes
// all state to Supabase via the sync-ingest edge function every 60s.
// This legacy tool hit PostgREST directly with anon key, which RLS blocks.
